local WinEditor_map_entity_list_ui = M
require("lfs")
local cjson = require("cjson")

function WinEditor_map_entity_list_ui:init()
...
function WinEditor_map_entity_list_ui:initUI()
...
function WinEditor_map_entity_list_ui:initEvent()
...
function WinEditor_map_entity_list_ui:subscribeEvent()
end

function WinEditor_map_entity_list_ui:getEntityCfgList()
...
function WinEditor_map_entity_list_ui:getSceneEntityList()
  return Plugins.CallTargetPluginFunc("scene_ui", "getAllSceneUI")
end

function WinEditor_map_entity_list_ui:updateSceneObjList()
  self.sceneObjGridView:invoke("INIT_CONFIG", 0, 10, 1)
...
function WinEditor_map_entity_list_ui:updateSceneInfoParams()
...
function WinEditor_map_entity_list_ui:updateSceneUIInfo()
...
function WinEditor_map_entity_list_ui:updateSceneUI()
  local uiParams = self.select_ui:root():data("sceneUIParams")
  local key = uiParams.key
  local uiCfg = Plugins.CallTargetPluginFunc("scene_ui", "getSceneUICfg", key)
...
function WinEditor_map_entity_list_ui:updateSceneInfo(cui)
  self.select_ui = cui
  self.sceneInfoGridView:RemoveAllItems()
  self:updateSceneUIInfo()
end

function WinEditor_map_entity_list_ui:delete()
...
function WinEditor_map_entity_list_ui:add()
...
function WinEditor_map_entity_list_ui:_saveSceneUI(jsonData)
...
function WinEditor_map_entity_list_ui:save()
...
function WinEditor_map_entity_list_ui:initView()
  self:updateSceneObjList()
end

function WinEditor_map_entity_list_ui:onHide()
  UI:closeWnd("editor_map_entity_ui")
end

function WinEditor_map_entity_list_ui:onShow(isShow)
  if isShow then
...
function WinEditor_map_entity_list_ui:onOpen()
  self._allEvent = {}
  self:initView()
  self:subscribeEvent()
end

function WinEditor_map_entity_list_ui:onClose()
...
return WinEditor_map_entity_list_ui
