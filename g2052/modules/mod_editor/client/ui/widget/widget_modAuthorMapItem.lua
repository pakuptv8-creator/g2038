...
local WidgetModAuthorMapItem = Lib.derive(widget_base)
local ModAsyncProxy = T(Lib, "ModAsyncProxy")

function WidgetModAuthorMapItem:init()
...
function WidgetModAuthorMapItem:initUI()
...
function WidgetModAuthorMapItem:initEvent()
...
function WidgetModAuthorMapItem:onDataChanged(data)
  data = data.data
...
function WidgetModAuthorMapItem:onDestroy()
